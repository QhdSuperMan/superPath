  ...
  <div class="list-common-style-container">
    ...
    <div class="table-list">
      <div class="table-list-btns">
        <CustomButton icon="delete" size="small" v-if="btnAuthority.s_receive" @click="batchOperation(1)"
          >领取
        </CustomButton>
        <CustomButton icon="delete" size="small" v-if="btnAuthority.s_delete" @click="batchOperation(5)"
          >删除</CustomButton
        >
        <CustomButton icon="delete" size="small" v-if="btnAuthority.s_dispatch" @click="batchOperation(7)"
          >派发</CustomButton
        >
      </div>
      <CustomTable
...
import { getHighSeaList } from "@/api/customer/customer.js";
